...
mixin _$User {
 ...
 Uid get uid => throw _privateConstructorUsedError; String get nickName => throw _privateConstructorUsedError; Token get token => throw _privateConstructorUsedError;
...
@useResult
$Res call({
 Uid uid, String nickName, Token token
});
...
as Uid,nickName: null == nickName ? _value.nickName : nickName // ignore: cast_nullable_to_non_nullable
...
class _$UserImpl  implements _User {
  const _$UserImpl({required this.uid, required this.nickName, required this.token});
...
@override
String toString() {
  return 'User(uid: $uid, nickName: $nickName, token: $token)';
}


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _$UserImpl&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.nickName, nickName) || other.nickName == nickName)&&(identical(other.token, token) || other.token == token));
}
...
abstract class _User implements User {
  const factory _User({required final  Uid uid, required final  String nickName, required final  Token token}) = _$UserImpl;
